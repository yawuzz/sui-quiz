...
export default function Room() {
      ...
      <div className="min-h-screen bg-gradient-background p-6">
        <div className="max-w-xl mx-auto">
          <Card className="bg-gradient-card border-border/50">
            <CardHeader>
              <CardTitle className="text-center">Room is missing</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Open a room from Home or visit a link like <code>/room/ABC123</code>.
              </p>
  ...
  useEffect(() => {
    ...
    ws.addEventListener("open", () => {
      ...
      // Host'tan soruları yükle (HostDashboard'tan navigate state ile geliyorsa)
    ...
    ws.addEventListener("error", (e) => {
      ...
      alert("WS error (room). Check DevTools.");
    });
        ...
        <Card className="bg-gradient-card border-border/50">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              <Button onClick={openPlayerView}>Open Player View</Button>
